...
if "%~1"=="" goto :usage
if "%~1"=="status_zapret" goto :status_zapret
if "%~1"=="check_updates" goto :check_updates_cmd
if "%~1"=="load_game_filter" goto :load_game_filter_cmd
if "%~1"=="load_user_lists" goto :load_user_lists_cmd
if "%~1"=="install" goto :install_cmd
if "%~1"=="remove" goto :remove_cmd
if "%~1"=="status" goto :status_cmd
if "%~1"=="game_switch" goto :game_switch_cmd
if "%~1"=="ipset_switch" goto :ipset_switch_cmd
if "%~1"=="check_updates_switch" goto :check_updates_switch_cmd
if "%~1"=="ipset_update" goto :ipset_update_cmd
if "%~1"=="hosts_update" goto :hosts_update_cmd
if "%~1"=="diagnostics" goto :diagnostics_cmd
if "%~1"=="run_tests" goto :run_tests_cmd
...
:: ==================== Подпрограммы (оригинальные с изменениями) ====================
...
if !errorlevel!==0 (
    ...
    sc query "WinDivert" >nul 2>&1
    if !errorlevel!==0 sc delete "WinDivert" >nul 2>&1
)
